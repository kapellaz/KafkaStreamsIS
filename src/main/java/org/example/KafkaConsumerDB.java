    ...
    public static void ReadDB() {
        ...
        lines.foreach((key, value) -> {
            try {
                ...
                topicHash.put(Integer.toString(sockId), new Sale_Operation(sockId, sockType, sockPrice, quantity,
                        sockSupplierId, operation, socktypeid));
                wait = false;
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        while (true) {
            if (topicHash.size() == 0) {
                ...
                for (Map.Entry<String, Sale_Operation> entry : topicHash.entrySet()) {
                    ...
                    String a = "{\"type\"" + ":" + "\"" + v.getType() + "\"" + "," + "\"pricePerPair\"" + ":"
                            + v.getPricePerPair() + "," + "\"quantity\"" + ":" + v.getQuantity()
                            + ",\"supplierIdentifier\"" + ":" + "\"" + v.getSupplierIdentifier() + "\"}";
